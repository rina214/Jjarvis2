...
class DrawView : View {
  ...
  private var position = ArrayList<Pair<Float, Float>>()
  ...
  fun getPosition() : ArrayList<Pair<Float, Float>> {
    return position
  }
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    for ((index, pointF) in mDrawPoint.withIndex()) {
      ...
      position[index] = Pair(pointF.x / mRatioWidth, pointF.y / mRatioHeight)
    }
  }
